...
# --- FINAL OPTIMIZED STRATEGY PARAMETERS (from GA 2022-2024) ---
OPTIMAL_CENTER_DISTANCE = 0.06845880041198227
OPTIMAL_LEVERAGE = 6.1440852287730205
OPTIMAL_EXPONENT = 0.8417039838296924
OPTIMAL_STOP_LOSS_PERCENT = 0.032163070773567434
OPTIMAL_REENTRY_PROXIMITY_PERCENT = 0.029098279423892606
OPTIMAL_SMA_PERIOD = 157
            ...
            if self.path == '/':
                ...
                <body class="p-8">
                    <div class="container mx-auto p-4 bg-gray-800 shadow-xl rounded-xl">
                        <h1 class="text-3xl font-bold mb-4 text-green-400">Backtest Results: {SYMBOL} Final Optimized Strategy (Bear Market Focus)</h1>
                        
                        <div class="mb-8">
                            <h2 class="text-xl font-semibold mb-3 text-gray-200">Strategy Metrics Comparison</h2>
                            <p class="text-gray-400 mb-2">Final backtest run using parameters optimized for the 2022-2024 period:</p>
