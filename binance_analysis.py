...
def run_genetic_algorithm(df):
    """Main GA loop."""
    print("\n" + "=" * 80)
    print("STARTING GENETIC ALGORITHM OPTIMIZATION (IN-SAMPLE: FIRST 50% OF DATA)")
    ...
    for generation in range(GENERATIONS):
        ...
        for j in range(0, POPULATION_SIZE, 2):
            p1 = parents[j]
            p2 = parents[j+1] if j+1 < POPULATION_SIZE else parents[j] # Handle odd population size
