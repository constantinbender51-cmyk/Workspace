...
# --- Optimization Period (New In-Sample Window) ---
OPT_START_DATE = '2022-01-01'
OPT_END_DATE = '2024-01-01'
...
def run_genetic_algorithm(df):
    ...
    print("\n" + "=" * 80)
    print("STARTING GENETIC ALGORITHM OPTIMIZATION (NEW IN-SAMPLE WINDOW)")
    ...
    try:
        # Note: Using .copy() is important to avoid SettingWithCopyWarning
    ...
    for generation in range(GENERATIONS):
        ...
        for j in range(0, POPULATION_SIZE, 2):
            p1 = parents[j]
            # Handle odd population size by letting the last parent crossover with itself
...
if __name__ == '__main__':
    ...
    if df_data.empty:
        ...
        if optimal_params is not None:
             ...
             print("\nOptimization successful. Please review the optimal parameters above.")
        else:
