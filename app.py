...
def generate_plot(df):
    ...
    # Title and legends
    plt.title('Strategy Cumulative Returns and Price with Leverage (1x), Stop Loss (5%), and ATR 14-based Background (Green if range/ATR < 1, Red if >= 1)')
...
def index():
    ...
    try:
        ...
        <body>
            ...
            <p>Stop loss: 5%, Leverage: 1x. ATR 14 calculated and plotted. Background: green if yesterday's range/ATR 14 < 1, red if >= 1.</p>
