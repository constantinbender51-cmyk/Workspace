...
def generate_plot(df):
    ...
    # Title and legends
    plt.title('Strategy Cumulative Returns and Price with Leverage (1x), Stop Loss (5%), and ATR 29-based Background (Grey if ATR > 3000, White otherwise)')
...
def index():
    ...
    try:
        ...
        <body>
            ...
            <p>Stop loss: 5%, Leverage: 1x. ATR 29 calculated and plotted. Background: grey if yesterday's ATR 29 > 3000, white otherwise.</p>
